...
export const platformConfigs: Record<string, PlatformBuildConfig> = {
    ...
    partykit_server: {
        ...
        platformEntrypoint: '@springboardjs/platforms-partykit/src/entrypoints/partykit_server_entrypoint.ts',
        platformMacro: 'fetch',
    ...
    server: {
        target: 'node',
        name: 'server',
        platformEntrypoint: 'springboard-server/src/entrypoints/local-server.entrypoint.ts',
        platformMacro: 'node',
        outDir: 'server/dist',
        format: 'cjs',
    ...
    mobile: {
        target: 'browser',
        name: 'mobile',
        platformEntrypoint: '@springboardjs/platforms-react-native/entrypoints/react_native_entrypoint.ts',
