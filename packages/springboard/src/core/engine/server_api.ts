import {ServerStateSupervisor, StateSupervisor} from '../services/states/shared_state_service.js';
import {CoreDependencies, ModuleDependencies} from '../types/module_types.js';
import type {ActionCallback, ActionCallOptions} from './module_api.js';
